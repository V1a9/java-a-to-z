...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
    <ul class="navbar-nav">
        ...
        <li class="nav-item active">
            <a class="nav-link" href="newadvert.do">New Advertisement</a>
        </li>
        <li class="nav-item active">
...
<div class="container">
    ...
    <form method="POST" enctype="multipart/form-data" action="${pageContext.request.contextPath}/addphoto.do?advertId=${advertId}">
        File to upload:<br>
